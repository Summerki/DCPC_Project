...
{  
   ...
   /// <remarks>add by zhidanfeng 2017.2.19</remarks>
    ...
    public class Speedboard : Control
    {
        ...
        static Speedboard()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(Speedboard), new FrameworkPropertyMetadata(typeof(Speedboard)));
        }
        #endregion
        ...
        {
            Speedboard speedboard = d as Speedboard;
            speedboard.OldAngle = speedboard.Angle;
            speedboard.SetAngle();
            speedboard.TransformAngle();
        }
        #endregion
        ...
        public static readonly DependencyProperty SkinProperty = DependencyProperty.Register("Skin",
            typeof(SpeedboardSkinEnum),
            typeof(Speedboard),
            new PropertyMetadata(SpeedboardSkinEnum.Speed));

        /// <summary>
        /// 刻度盘样式
        /// </summary>
        public SpeedboardSkinEnum Skin
        {
            get { return (SpeedboardSkinEnum)GetValue(SkinProperty); }
        ...
        public static readonly DependencyProperty ContentProperty =
            DependencyProperty.Register("Content", typeof(object), typeof(Speedboard));
        #endregion
        ...
        public static readonly DependencyProperty ContentTemplateProperty =
            DependencyProperty.Register("ContentTemplate", typeof(DataTemplate), typeof(Speedboard));
        #endregion
